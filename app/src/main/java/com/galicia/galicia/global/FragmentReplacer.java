...
//    public static final void replaceFragmentWithoutBackStack(final Activity _activity,
//                                                             final Fragment _fragment) {
//        if ( _activity.getFragmentManager().getFragments() == null ||
//                !((Object) _activity.getFragmentManager().getFragments().get(0)).getClass().getName().
//                        equals(((Object)_fragment).getClass().getName())) {
//            _activity.getFragmentManager().popBackStackImmediate(null, FragmentManager.POP_BACK_STACK_INCLUSIVE);
//            _activity.getFragmentManager().beginTransaction()
